...
//cek level user
if($_SESSION['departemen']!="customer_service"){
    die("Anda bukan customer service");//jika bukan admin jangan lanjut
}
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href=""><i class="fa fa-fw fa-edit"></i> Manage Status Pengiriman Muatan</a>                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </nav>
