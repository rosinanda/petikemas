...
while($p = mysql_fetch_array($pesan)){
		$content='
			<div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Membuat Draft Bill of Lading</h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-fw fa-bar-chart-o"></i>Draft Bill of Lading</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
					...
					<div class="tab-content">
												...
												<form name="form1" method="post" action="insert_bl.php">
												 <fieldset>
													...
													&nbsp;
													<div class="form-group">
														<label class="col-sm-4 control-label">Nomor Container</label>
														<div class="col-sm-8">
														<input type="text" class="form-control" name="no_container" value= '.$p['no_container'].' required>
														</div>
													</div>
													&nbsp;
													&nbsp;
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="harga_pengiriman" required>
														</div>
													</div>
													&nbsp;
													<center>
													<div class="form-group">
													  <input type="submit" name="buat_draft" class="btn btn-default" value="Send">
													</div>
												 </center>
													</fieldset>
...
$update = mysql_query("UPDATE si SET draft_bl='sudah'
WHERE no_si='$no'");
